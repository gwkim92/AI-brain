...
const EnvSchema = z.object({
  ...
  RUNNER_ENABLED: EnvBooleanSchema.default(false),
  RUNNER_POLL_INTERVAL_MS: z.coerce.number().int().min(1000).default(60000),
  RUNNER_REPO_ROOT: z.string().optional(),
  RUNNER_MAX_ATTEMPTS: z.coerce.number().int().min(1).max(10).default(2),
  RUNNER_LINEAR_DIRECT_ENABLED: EnvBooleanSchema.default(false),
  RUNNER_STALL_TERMINATE_ENABLED: EnvBooleanSchema.default(true),
  RADAR_SCANNER_WORKER_ENABLED: EnvBooleanSchema.default(true),
  RADAR_SCANNER_WORKER_POLL_MS: z.coerce.number().int().min(1000).default(300000),
  RADAR_SCANNER_WORKER_BATCH: z.coerce.number().int().min(1).max(200).default(12),
  RADAR_SCANNER_FETCH_TIMEOUT_MS: z.coerce.number().int().min(1000).default(8000),
  INTELLIGENCE_SCANNER_WORKER_ENABLED: EnvBooleanSchema.default(true),
  INTELLIGENCE_SCANNER_WORKER_POLL_MS: z.coerce.number().int().min(1000).default(300000),
  INTELLIGENCE_SCANNER_WORKER_BATCH: z.coerce.number().int().min(1).max(200).default(10),
  INTELLIGENCE_SCANNER_FETCH_TIMEOUT_MS: z.coerce.number().int().min(1000).default(12000),
  INTELLIGENCE_SEMANTIC_WORKER_ENABLED: EnvBooleanSchema.default(true),
  INTELLIGENCE_SEMANTIC_WORKER_POLL_MS: z.coerce.number().int().min(1000).default(120000),
  INTELLIGENCE_SEMANTIC_WORKER_BATCH: z.coerce.number().int().min(1).max(500).default(60),
  INTELLIGENCE_STALE_MAINTENANCE_WORKER_ENABLED: EnvBooleanSchema.default(true),
  INTELLIGENCE_STALE_MAINTENANCE_WORKER_POLL_MS: z.coerce.number().int().min(1000).default(600000),
  INTELLIGENCE_STALE_MAINTENANCE_WORKER_BATCH: z.coerce.number().int().min(1).max(50).default(5),
  INTELLIGENCE_MODEL_SYNC_WORKER_ENABLED: EnvBooleanSchema.default(true),
  INTELLIGENCE_MODEL_SYNC_WORKER_POLL_MS: z.coerce.number().int().min(10000).default(21600000),
  ...
  LINEAR_BASE_URL: z.string().url().default('https://api.linear.app/graphql'),
